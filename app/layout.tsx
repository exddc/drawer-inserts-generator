...
export default function RootLayout({
    ...
    return (
        <html lang="en" className="h-full">
            <body
                className={`${PPMontreal.variable} ${PPMontrealMono.variable} flex flex-row h-full overflow-hidden antialiased bg-[#EDEDED] p-6 gap-6 pr-0 tracking-tighter font-sans`}
            >
                <Sidebar />
