...
import { StoreState, SharingState } from '../types'
import { encodeBoxConfig, decodeBoxConfig, getConfigFromUrl } from '../urlUtils'

export const createSharingSlice: StateCreator<StoreState, [], [], SharingState> = (
  set,
  get,
  store
) => ({
